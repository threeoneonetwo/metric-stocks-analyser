...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col">
      <TopBar />
      <section className="mx-auto flex w-full max-w-[42rem] flex-1 flex-col gap-[10px] px-4 pb-10 pt-20 sm:px-6">
        <div className="flex flex-col items-center gap-[10px] text-center">
          ...
          <p className="animate-entrance delay-2 max-w-[32rem] text-lg leading-7">
            Our agentic engine monitors the Indian equity market to
            identify high-probability breakout patterns.
          </p>
        </div>
