...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col">
      <TopBar />
      <section className="mx-auto flex w-full max-w-[42rem] flex-1 -translate-y-12 flex-col justify-center gap-[10px] px-4 py-10 sm:px-6">
        <div className="flex flex-col items-center gap-[10px] text-center">
          ...
          <p className="animate-entrance delay-2 max-w-full text-[clamp(13px,3.55vw,18px)] leading-[32px]">
